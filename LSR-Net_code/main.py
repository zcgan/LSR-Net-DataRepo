                ...
                for fouirer_channel in fouirer_channels:
                    for kernel_size in kernel_sizes:
                        ...
                        pre_net1 = Wise_SpectralTransform(num_layers=num_layers, channel_feat=features, kernel_size=kernel_size,
                                                         fourier_channels=fouirer_channel,phase=1, initial_parameters=initial_parameters)
                        ...
                        pre_net3 = Wise_SpectralTransform(num_layers=num_layers, channel_feat=features, kernel_size=kernel_size,
                                                         fourier_channels=fouirer_channel,phase=3, initial_parameters=initial_parameters3)
                        ...
                        net = Wise_SpectralTransform(num_layers=num_layers, channel_feat=features, kernel_size=kernel_size,phase=4,
                                                     fourier_channels=fouirer_channel,initial_parameters=initial_parameters4)
                        # # Save model summary for phase 2 model
                        ...
                        with open(os.path.join(outf, "model_summary.txt"), 'a') as f:
                            ...
                            f.write("=" * 80 + "\n")
                        n_params1 = count_model_params(pre_net1)
                        print(f'\npre_net1参数数量: {n_params1}')
                        n_params2 = count_model_params(pre_net2)
                        print(f'\npre_net2参数数量: {n_params2}')
                        n_params3 = count_model_params(pre_net3)
                        print(f'\npre_net3参数数量: {n_params3}')
                        n_params4 = count_model_params(net)
                        print(f'\nnet参数数量: {n_params4}')
